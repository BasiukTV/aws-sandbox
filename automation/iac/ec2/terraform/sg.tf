...
module "sg" {
  ...
  count = var.security_group != null && var.security_group.existing_security_group_id == null ? 1 : 0
  ...
  security_group_vpc_id      = try(module.vpc[0].vpc_id, var.security_group.new_security_group.security_group_vpc_id)
